...
public class AddresaableTempraryTester : MonoBehaviour
{
    ...
    static string folderFilter = "t:Folder";
    ...
    private static void CreatOrMoveEntryIntoGroup(string ruleGUID)
    {
        ...
        {
            assetGUIDs = AddressabelUtilities.FindDirectChildren(assetFilter, dic);
            //Debug.LogError(assetGUIDs.Length);
        }
        else
        {
            assetGUIDs = AssetDatabase.FindAssets(assetFilter, new string[] { dic });
        }
